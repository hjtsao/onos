...
#include "include/table1.p4"
#include "include/permission_acl.p4"
...
control ingress(inout headers_t hdr,
    ...
    apply {
        ...
        permission_acl_ingress.apply(hdr, local_metadata, standard_metadata);
        if(local_metadata.user_pipeline_id == 1){
            table1_control.apply(hdr, local_metadata, standard_metadata);
...
control egress(inout headers_t hdr,
    ...
    apply {
        ...
        permission_acl_egress.apply(hdr, local_metadata, standard_metadata);
